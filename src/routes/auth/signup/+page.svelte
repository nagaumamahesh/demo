...
<div class="container mx-auto max-w-5xl px-10 mt-10"> 
    <form>
        <div class="grid gap-6 mb-6 md:grid-cols-2">
          ...
          <div>
            ...
            <Input type="url" id="website" placeholder="hello.com" required />
          </div>
          <div>
            <Label for="visitors" class="mb-2">Number Field</Label>
